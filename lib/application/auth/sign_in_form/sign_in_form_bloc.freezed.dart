...
mixin _$SignInFormEvent implements DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties..add(DiagnosticsProperty('type', 'SignInFormEvent'));
  }
...
extension SignInFormEventPatterns on SignInFormEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case SignInWithGooglgePressed() when signInWithGooglePressed != null:
...
class EmailChanged with DiagnosticableTreeMixin implements SignInFormEvent {
...
class PasswordChanged with DiagnosticableTreeMixin implements SignInFormEvent {
...
class SignInWithEmailAndPasswordPressed
...
class SignInWithGooglgePressed
    with DiagnosticableTreeMixin
    implements SignInFormEvent {
  const SignInWithGooglgePressed();
