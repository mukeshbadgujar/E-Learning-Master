...
/// Adds pattern-matching-related methods to [UserCommentDto].
extension UserCommentDtoPatterns on UserCommentDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserCommentDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserCommentDto() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String commentId, String userId, String commentDescription,
            DateTime commentAt)?
        $default, {
    required TResult orElse(),
  }) {
  ...
  TResult? whenOrNull<TResult extends Object?>(
    TResult? Function(String commentId, String userId,
            String commentDescription, DateTime commentAt)?
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
/// @nodoc
@JsonSerializable()
class _UserCommentDto extends UserCommentDto {
