...
mixin _$FirebaseFailure {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is FirebaseFailure);
  }
...
/// @nodoc
class $FirebaseFailureCopyWith<$Res> {
  $FirebaseFailureCopyWith(
      FirebaseFailure _, $Res Function(FirebaseFailure) __);
}
...
class _Unexpected implements FirebaseFailure {
  const _Unexpected();
...
class _InsufficientPermission implements FirebaseFailure {
...
class _UnableToUpdate implements FirebaseFailure {
